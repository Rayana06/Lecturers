...
export class ProductPage {
    ...
    getData() {
        const teachers = [
            {
                id: 1,
                name: "Михаил Владимирович Белодедов",
                lessons: [
                    ...
                    { day: "ПН", time: "15:55 – 17:25", type: "Семинвр", room: "213х", group: "ИУ5-42Б, ИУ5И-47Б" },
            ...
            {
                id: 2,
                name: "Константин Юрьевич Маслеников",
                lessons: [
        ...
        return teachers.find(teacher => teacher.id === this.id) || teachers[0];
    }
